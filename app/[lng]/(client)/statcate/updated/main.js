...
import { incrementDownloadViews } from "@/app/services/actions";
...
export default function Main({ sector, subsector, lng }) {
    ...
    useEffect(() => {
        ...
        const fetchSubcategories = async () => {
            try {
                const response = await fetch(`/api/download?info=${subsector}&lng=${lng}&type=updatereports`);
        ...
        <div className="bg-white">
            ...
            >
                ...
                <Column
                    ...
                    body={(rowData) => (
                        <div onClick={() => {
                            incrementDownloadViews(rowData.id)
