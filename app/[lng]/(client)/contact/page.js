...
export default function Contact({ params: { lng } }) {
    ...
    const options = {
        ...
        q2: {
            ...
            "Лавлах утас 19001212, 70141212, 70151212": 6
        },
        q3: {
                    ...
                    {loading ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl mx-auto text-sm">
                            ...
                            <div>
                                ...
                                {["www.1212.mn", "Сошиал сувгууд", "Телевизийн сувгууд", "Сонин, хэвлэл", "Мэдээллийн сайтууд", "Лавлах утас 19001212, 70141212, 70151212"].map((option, idx) => (
                                    <label key={idx} className="block pl-4">
                                        <input
                                            type="radio"
                                            name="q2"
