            ...
            <div className="nso_container">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-10">
                    <div className="flex flex-col items-center cursor-pointer text-justify text-[--font-size15] hover:scale-[1.01] transition-transform"
                        ...
                        <span className="desc">{lng === "mn" ? "Таны  орлого, цалин, хөдөлмөр эрхлэлтийг улсын дундажтай харьцуулахад (2023)" : ""}</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center cursor-pointer text-justify text-[--font-size15] hover:scale-[1.01] transition-transform"
                        ...
                        <span className="desc">{lng === "mn" ? "Эндээс та Монгол Улсын хэддэх иргэн болон танай ижил нэртэй хүмүүсийн мэдээллийг авах боломжтой." : ""}</span>
                    </div>

                    <div className="flex flex-col items-center cursor-pointer text-justify text-[--font-size15] hover:scale-[1.01] transition-transform"
                        onClick={() => router.push(`/statistic/fun-statistic/historicalGivenName`)}
                        style={{ width: "300px" }}>
                        <img
                            className="w-[250px] h-[250px] rounded-[20px]"
                        ...
                        <span className="desc">{lng === "mn" ? "Монгол Улсын түүх болж үлдсэн хүмүүстэй ижил нэртэй хүмүүсийн жагсаалт" : ""}</span>
                    </div>
                    <div className="flex flex-col items-center cursor-pointer text-justify text-[--font-size15] hover:scale-[1.01] transition-transform"
                        ...
                        <span className="desc">{lng === "mn" ? "Монгол Улсын хүн амын ургийн овгийн тоо баримт." : ""}</span>
                    </div>
                    {/* <div className="flex flex-col items-center cursor-pointer text-justify text-[--font-size15] hover:scale-[1.01] transition-transform"
                        onClick={() => router.push(`/statistic/fun-statistic/household`)}
                        style={{ width: "300px" }}>
