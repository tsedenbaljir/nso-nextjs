...
export default function Tabs({ tabs, sector, subsector }) {
        ...
        <div id="stat_cate" className="nso_cate_body">
            ...
            <TabView
                ...
                onTabChange={(e) => {
                    ...
                    router.push(`/statecate/${newTab}/${sector}/${subsector}`); // ✅ Navigate to new tab
                }}
            >
                {/* Хүснэгт Tab */}
                <TabPanel header="Хүснэгт">
                    <TablesData sector={sector} subsector={subsector} />
                </TabPanel>

                {/* Other Tabs */}
                <TabPanel header="Танилцуулга">
                    <MainIndicator sector={sector} subsector={subsector} />
                </TabPanel>
