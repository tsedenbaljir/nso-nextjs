    ...
    const items = [
        {
            ...
            children: (
                <div className="contact-content w-full" style={{ width: '100%' }}>
                    ...
                    <div className="contact-info text-center mt-4 font-semibold">
                        <p>{t('footer.address')}: {t('footer.addressText')}</p>
                        <p>{t('footer.infoPhone')}: <span className='text-blue-500 underline'>70141212, 51-261502</span> {t('footer.mail')}: <span className='text-blue-500 underline'>information@nso.mn, international@nso.mn</span></p>
                    </div>
                </div>
            ),
        },
