...
export async function GET(req, { params }) {
  ...
  try {
    const query = `
        SELECT [id], [meta_data_id], [label], [label_en], [namemn], [nameen], [attachment_name], [data_catalogue_id], [data_catalogue_mn], [data_catalogue_en], [valuemn], [valueen], [last_modified_date], [is_secret], [active]
