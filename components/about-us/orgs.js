                                ...
                                <div className="dialog-body">
                                    <div className="header">
                                        ...
                                        {datas[where].id === 24 && (
                                            <>
                                                <br />
                                                <a className="underline" href="https://beta.nso.mn/uploads/images/16p_4dRstR2UyuZ-_tJK9cikjthfYtkQ47JZ64y-.pdf" target="_blank">
                                                    ДЗХ-ын ажиллах журам 2021 А72
                                                </a>
                                                <br />
                                                <a className="underline" href="https://beta.nso.mn/uploads/images/9PwHbeEV1P9Sv_ZIXsiccOiPAHrSRB-UX1_Nwk0e.pdf" target="_blank">
                                                    ДЗ бүрэлдэхүүн шинэчилсэн баталсан тухай 2023 оны А105
                                                </a>
                                                <br />
                                                <a className="underline" href="https://beta.nso.mn/uploads/images/P4rQhUz5Qba8trdnzPkj1q3Vx-crSIq8_o_HMwS6.pdf" target="_blank">
