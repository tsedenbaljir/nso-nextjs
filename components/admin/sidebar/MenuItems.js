            ...
            <Link href={"/admin/" + link}>
                <div
                    className={`relative flex rounded-[7px] px-3.5 py-2 font-medium duration-300 ease-in-out ${isActive
                        ...
                        : "text-dark-4 hover:bg-gray-3 hover:text-dark dark:text-gray-5 dark:hover:bg-white/10 dark:hover:text-white"
                        }`}
                >{name}</div>
            </Link>
            <div>
                {/* <li>
                  <Link href="/dashboard" className={`relative flex rounded-[7px] px-3.5 py-2 font-medium duration-300 ease-in-out ${pth === "dashboard"
                    ? "bg-primary/[.07] dark:bg-white/10 dark:!text-white !text-primary"
