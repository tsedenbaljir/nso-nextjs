                ...
                <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
                    ...
                    <div className="flex items-center justify-normal gap-2 2xsm:gap-4 lg:w-full lg:justify-between xl:w-auto xl:justify-normal">
                        <ul className="flex items-center gap-2 2xsm:gap-4">
                            {pth !== "dashboard" && pth !== "laws" && pth !== "glossary" && pth !== "classification" && pth !== "user-management" && pth !== "bulletin" && pth !== "contact-us" && pth !== "file-library" && pth !== "report" && pth !== "contact" && pth !== "subscribeEmail" && pth !== "commodity-price" && pth !== "cpi-ppi" && pth !== "analytics"
                                && <Link href={
