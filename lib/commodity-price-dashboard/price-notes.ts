...
export const MARKET_PRICE_METHOD_NOTE =
  "Улаанбаатар хотын хэрэглэгчдийн нийтлэг үйлчлүүлдэг зах, худалдааны цэгүүдээс үнийн мэргэжилтнүүдийн биечлэн цуглуулсан үнийн мэдээлэлд үндэслэн дундаж үнийг тооцсон бөгөөд хэрэглээний үнийн индекс тооцох аргачлалын дагуу хямдралтай болон урамшуулалт үнийг тооцоонд хамруулаагүй.";
